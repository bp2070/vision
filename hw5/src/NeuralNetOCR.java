...
class NeuralNetOCR {
    ...
    private static double gain = .01;
    private static ANN net;
    private static String RESOURCE_DIR = "C:\\Users\\bryan\\workspace\\vision\\hw5\\res\\";
    ...
    private static void train(List<String> filenames) {
        ...
        for (String filename : filenames) {
            try {
                images.add(VisionUtil.read(RESOURCE_DIR + filename, IMAGE_SIZE));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
